...
from textual.widgets import Header, Footer, ListView, ListItem, Label, Input, Select, Button, TextArea
...
class EditorApp(App):
    ...
    def save_current_state(self) -> None:
        ...
        q.required_chunks = [c.strip() for c in chunks_text.splitlines() if c.strip()]
    ...
    def action_save(self) -> None:
        ...
        self.notify("Golden set saved successfully!", title="Saved", severity="information")
    ...
    def action_delete_question(self) -> None:
        ...
        self.golden_set.questions = [
            q for q in self.golden_set.questions if q.id != self.current_question.id
        ]
